...
<span class="gem-chip"><span class="gem-num">4</span> ![](../assets/re/icon-turningslash.png) Turning Slash</span>
<span class="gem-chip"><span class="gem-num">5</span> ![](../assets/re/icon-soulabsorber.png) Soul Absorber</span>
...
<span class="gem-chip"><span class="gem-num">3</span> ![](../assets/re/icon-headhunt.png) Head Hunt</span>
<span class="gem-chip"><span class="gem-num">4</span> ![](../assets/re/icon-turningslash.png) Turning Slash</span>
</div>
</div>
...
=== "Openers"
    ...
    *From 3 orbs (![](../assets/shared/icon-stimulant.png){: .skill-icon } Stimulant):*
    ...
    - Blade Assault is interchangeable with Cycle 2 if it's available.
