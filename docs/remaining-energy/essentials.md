...
| [111 (Head Hunt)](111-head-hunt.md) | <div class="table-bar-cell">9 / 10<div class="stat-bar-track"><div class="stat-bar-fill" style="width: 90%"></div></div></div> | <div class="table-bar-cell">1.18x<div class="stat-bar-track stat-bar-track-teal"><div class="stat-bar-fill stat-bar-fill-teal" style="width: 60%"></div></div></div> | Fast & Punishing | ⚠️ Skill expression and stagger |
...
| ![](../assets/re/icon-headhunt.png) | **Head Hunt**<br>*2200 meter* | <span class="tag tag-util">COUNTER</span><span class="tag tag-util">RECOVERY</span><span class="tag tag-warn">NOT PARALYSIS IMMUNE</span> | — |
